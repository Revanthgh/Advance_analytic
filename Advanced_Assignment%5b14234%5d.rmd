...
```{r}
given_data<-read.table("C:/Users/Admin/Downloads/MG226/assignment/spyder_strength.data", header = TRUE)
```
...
```{r}
boxplot(y~treatment,font.main=1,cex.main=1,xlab="Treatment", ylab="Torque Required(foot pounds)")
```
